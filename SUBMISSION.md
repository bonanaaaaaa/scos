...
| Stores data in a database                                                                | PostgreSQL through Prisma. Normalized schema for warehouses, orders and allocations, with migrations and a reproducible six-warehouse seed — [docs/database-schema.md](docs/database-schema.md)                                                                                |
...
The [repository map](docs/architecture.md#repository-map) places every directory
in that picture and says which document answers which question.
