...
src/
  ...
  openapi/         hono-openapi document options, offline generation, export and
...
`JSON.stringify(document, null, 2)` plus a newline, with no timestamps (key and
component order follow route registration, which is fixed), and
